...
<div class="container-wrapper">
    <div class="container">
        ...
        <c:if test="${pageContext.request.isUserInRole('ROLE_LEADER')}">
            <form:form action="${pageContext.request.contextPath}/rideLeader/rideout/editRideout" method="post"
                       commandName="rideout" enctype="multipart/form-data">
            ...
            <a href="<c:url value="/rideLeader/rideoutInventory" />" class="btn btn-warning">Cancel</a>
        </c:if>
    </div>
</div>
